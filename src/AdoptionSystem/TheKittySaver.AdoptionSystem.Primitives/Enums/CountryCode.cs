...
namespace TheKittySaver.AdoptionSystem.Primitives.Enums;
...
public enum CountryCode
{
    ...
    [Description("Algeria")] DZ = 12,
    [Description("American Samoa")] AS = 16,
    [Description("Andorra")] AD = 20,
    [Description("Angola")] AO = 24,
    [Description("Anguilla")] AI = 660,
    [Description("Antarctica")] AQ = 10,
    [Description("Antigua and Barbuda")] AG = 28,
    ...
    [Description("Azerbaijan")] AZ = 31,
    [Description("Bahamas")] BS = 44,
    [Description("Bahrain")] BH = 48,
    [Description("Bangladesh")] BD = 50,
    [Description("Barbados")] BB = 52,
    [Description("Belarus")] BY = 112,
    [Description("Belgium")] BE = 56,
    [Description("Belize")] BZ = 84,
    [Description("Benin")] BJ = 204,
    [Description("Bermuda")] BM = 60,
    [Description("Bhutan")] BT = 64,
    [Description("Bolivia (Plurinational State of)")] BO = 68,
    [Description("Bonaire, Sint Eustatius and Saba")] BQ = 535,
    [Description("Bosnia and Herzegovina")] BA = 70,
    [Description("Botswana")] BW = 72,
    [Description("Bouvet Island")] BV = 74,
    [Description("Brazil")] BR = 76,
    [Description("British Indian Ocean Territory")] IO = 86,
    [Description("Brunei Darussalam")] BN = 96,
    ...
    [Description("Congo")] CG = 178,
    [Description("Congo (Democratic Republic of the)")] CD = 180,
    [Description("Cook Islands")] CK = 184,
    [Description("Costa Rica")] CR = 188,
    [Description("Côte d'Ivoire")] CI = 384,
    ...
    [Description("Falkland Islands (Malvinas)")] FK = 238,
    ...
    [Description("French Southern Territories")] TF = 260,
    ...
    [Description("Iran (Islamic Republic of)")] IR = 364,
    ...
    [Description("Korea (Democratic People's Republic of)")] KP = 408,
    [Description("Korea (Republic of)")] KR = 410,
    [Description("Kuwait")] KW = 414,
    [Description("Kyrgyzstan")] KG = 417,
    [Description("Lao People's Democratic Republic")] LA = 418,
    ...
    [Description("Micronesia (Federated States of)")] FM = 583,
    [Description("Moldova (Republic of)")] MD = 498,
    ...
    [Description("Palestine, State of")] PS = 275,
    ...
    [Description("Russian Federation")] RU = 643,
    ...
    [Description("Saint Martin (French part)")] MF = 663,
    ...
    [Description("Sao Tome and Principe")] ST = 678,
    ...
    [Description("Sint Maarten (Dutch part)")] SX = 534,
    [Description("Slovakia")] SK = 703,
    [Description("Slovenia")] SI = 705,
    [Description("Solomon Islands")] SB = 90,
    [Description("Somalia")] SO = 706,
    [Description("South Africa")] ZA = 710,
    [Description("South Georgia and the South Sandwich Islands")] GS = 239,
    ...
    [Description("Syrian Arab Republic")] SY = 760,
    [Description("Taiwan")] TW = 158,
    [Description("Tajikistan")] TJ = 762,
    [Description("Tanzania, United Republic of")] TZ = 834,
    ...
    [Description("United Kingdom of Great Britain and Northern Ireland")] GB = 826,
    [Description("United States of America")] US = 840,
    ...
    [Description("Venezuela (Bolivarian Republic of)")] VE = 862,
    [Description("Viet Nam")] VN = 704,
    [Description("Virgin Islands (British)")] VG = 92,
    [Description("Virgin Islands (U.S.)")] VI = 850,
