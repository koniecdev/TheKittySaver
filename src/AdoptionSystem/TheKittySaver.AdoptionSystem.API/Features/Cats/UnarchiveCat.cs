...
internal sealed class UnarchiveCat : IEndpoint
{
    ...
    internal sealed class Handler : ICommandHandler<Command, Result>
    {
        ...
        {
            Maybe<Cat> maybeCat = await _catRepository.GetArchivedByIdAsync(command.CatId, cancellationToken);
            ...
            Result unarchiveResult = _catArchiveDomainService.Unarchive(cat);
    ...
    {
        endpointRouteBuilder.MapPost("cats/{catId:guid}/unarchive", async (
            Guid catId,
            ISender sender,
